...
CHAT_GROUP = int(environ.get("CHAT_GROUP", "-1002279954322"))
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002279954322') # support group id ( make sure bot is admin )
...
AI_LOGS = int(environ.get("AI_LOGS", "-1002350685005")) #GIVE YOUR NEW LOG CHANNEL ID TO STORE MESSAGES THAT THEY SEARCH IN BOT PM.... [ i have added this to keep an eye on the users message, to avoid misuse of Bot ]
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002192432040')) #Log channel id ( make sure bot is admin )
DUMP_CHNL = int(environ.get('DUMP_CHNL', '-1002366815842'))
...
BOT_USERNAME = environ.get("BOT_USERNAME", "Scarlett_fil_ter_bot")
BOT_NAME = environ.get("BOT_NAME", "scar")
BOT_ID = environ.get("BOT_ID", "7052301883")
...
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : universe')
